...
public class ChangeTracking extends Contract {
    ...
    @Deprecated
    public static ChangeTracking load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ChangeTracking(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ChangeTracking load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ChangeTracking(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static ChangeTracking load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new ChangeTracking(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static ChangeTracking load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new ChangeTracking(contractAddress, web3j, transactionManager, contractGasProvider);
    }
}
